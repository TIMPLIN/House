# Generated by Django 3.1 on 2020-08-20 02:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(choices=[('xa', '西安'), ('bj', '北京'), ('sh', '上海'), ('sz', '深圳'), ('gz', '广州'), ('hz', '杭州')], max_length=2, verbose_name='城市')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bedroom', models.CharField(choices=[('1', '1室1厅'), ('2', '2室1厅'), ('3', '2室2厅'), ('4', '3室1厅'), ('5', '3室2厅'), ('6', '4室2厅')], max_length=1, verbose_name='房型')),
